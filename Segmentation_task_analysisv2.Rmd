...
if(0) {
  write.csv(subject.segments,'./processed_data/results/segmentation_by_subject_11.18.19.csv',row.names = F)
 saveRDS(subject.keyPresses.v1,'./processed_data/results/segmentation.keypresses.v1.11.18.19')
  saveRDS(subject.keyPresses.v2,'./processed_data/results/segmentation.keypresses.v2.11.18.19')
  saveRDS(subject.keyPresses.v3,'./processed_data/results/segmentation.keypresses.v3.11.18.19')
