...
temp_list = list(vid1.segments.rt * 1000,vid2.segments.rt  * 1000,vid3.segments.rt * 1000)
...
<<<<<<< HEAD
if(0) {
  write.csv(subject.segments,'./segmentation_by_subject_temp.csv',row.names = F)
=======
if(1) {
...
fig.v3 <- subject.keyPresses.v3 %>% melt() %>% ggplot(aes(value, L1)) + geom_point(shape=3, size=2) +
  xlab('time(ss)') + ylab('Subject number') + 
  theme_classic(base_size = 18) +  xlim(c(1,50000)) + 
=======
