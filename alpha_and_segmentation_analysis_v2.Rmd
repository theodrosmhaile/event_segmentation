...
=======
segment.dat <- read.csv('./processed_data/results/segmentation_by_subject_11.18.19.csv')
>>>>>>> a576b1408dbe5a4ba2831f5d9472996443b8ca2e
subjects <- segment.dat$subject

 subject.keyPresses.v1 <- readRDS('./processed_data/results/segmentation.keypresses.v1.11.18.19')
  subject.keyPresses.v2 <- readRDS('./processed_data/results/segmentation.keypresses.v2.11.18.19')
  subject.keyPresses.v3 <- readRDS('./processed_data/results/segmentation.keypresses.v3.11.18.19')
...
EEG.data.alpha <- read.csv('./processed_data/alpha_only_EEG_data.csv')
