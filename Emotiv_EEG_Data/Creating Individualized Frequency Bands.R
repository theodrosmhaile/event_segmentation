...
#Input data 
SpectraFilename <- "EEG_spectra_allsubjs_summary_READ.csv" #"EEG_allsubjs_spectra.csv"

CoherenceSpectraFilename <- "EEG_coherence_allsubjs_summary_READ.csv"#"EEG_allsubjs_coherence.csv"
#If you do  not have or do not want the coherence data, enter "no" as the filename above

#Output data
RemovedFilename <- "Subjects_and_Channels_Removed.csv"

IAFFilename <- "Whole_Head_IAF_Values_for_Good_Subs.csv"

ROIspectraFilename <- "REALM_subjects_ROI_Spectra_Relative_to_IAF.csv"

FreqBandSummaryFilename <- "Individualized_Frequency_Band_Power_Summary.csv"
